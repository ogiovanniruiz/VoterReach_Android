...
public class LoginActivity extends AppCompatActivity{
    ...
    public void checkLogin(View arg0) {
        ...
        new AsyncLogin().execute(user,password,code);
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        ...
                        .appendQueryParameter("campaigncode", params[2]);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("\uFEFF\uFEFFtrue"))
            {
                ...
                Toast.makeText(LoginActivity.this, "You connected but have Invalid Username, password or Campaign Code.", Toast.LENGTH_LONG).show();

            }
            else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful"))
            {
                Toast.makeText(LoginActivity.this, "Huge Connection Problems.", Toast.LENGTH_LONG).show();
            }
        }
    }
}